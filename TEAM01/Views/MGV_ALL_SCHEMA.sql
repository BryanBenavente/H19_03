CREATE OR REPLACE FORCE VIEW team01.mgv_all_schema (project_id,project_name,connection_id,host,port,username,catalog_id,catalog_name,schema_id,schema_name) AS
